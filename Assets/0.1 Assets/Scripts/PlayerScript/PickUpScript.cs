...
namespace ItsaMeKen
{
    public class ObjectGrabber : MonoBehaviour
    {
        ...
        public Transform[] filePlaceholders;      // Array of placeholder positions for Files (small objects)
        ...
        private int isotopeIndex = 0, briefcaseIndex = 0, fileIndex = 0;
        ...
        void Start()
        {
            ...
            files = new GameObject[filePlaceholders.Length];
        }
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            else if (other.CompareTag("File") && fileIndex < filePlaceholders.Length)
            {
                grabbedObject = other.gameObject;
            }
        }
        ...
        private void OnGrab(InputAction.CallbackContext context)
        {
            if (grabbedObject != null)
            {
                ...
                else if (grabbedObject.CompareTag("File") && fileIndex < filePlaceholders.Length)
                {
                    GrabObject(files, filePlaceholders, ref fileIndex);
                }
            }
        }
        ...
        private void OnRelease(InputAction.CallbackContext context)
        {
            ...
            ReleaseObjects(briefcases, briefcasePlaceholders, ref briefcaseIndex); // Release Briefcases
            ReleaseObjects(files, filePlaceholders, ref fileIndex);           // Release Files
        }
